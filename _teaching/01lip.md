...
- Zkouška: Teoretická a praktická část vybraná z obsahu probraného na přednáškách.
  ...
  - Přihlásit se na zkoušku můžete i bez zápočtu v systému KOS, před skládáním zkoušky je však nutné formálně odevzdat zápočtový program, tj. zaslat přednášejícímu svou práci alespoň 1 den před termínem zkoušky + absolvovat krátkou konzultaci k programu (lze individuálně domluvit i na den zkouškového termínu).
